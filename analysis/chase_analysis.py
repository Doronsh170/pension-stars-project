...
CATEGORIES = {
    "gemel": [
        # קרן השתלמות
        'קרנות השתלמות | כללי',
        'קרנות השתלמות | מניות · כללי',
        'קרנות השתלמות | מניות · חו"ל',
        'קרנות השתלמות | מניות · ישראל',
        'קרנות השתלמות | אג"ח',
        # קופת גמל (תגמולים ואישית לפיצויים)
        'תגמולים ואישית לפיצויים | כללי',
        'תגמולים ואישית לפיצויים | מניות · כללי',
        'תגמולים ואישית לפיצויים | מניות · חו"ל',
        'תגמולים ואישית לפיצויים | מניות · ישראל',
