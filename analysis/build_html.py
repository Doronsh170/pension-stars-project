...
<div class="masthead"><div class="wrap">
  ...
  <div class="sourceline">
    <span><b>מקור:</b> גמל-נט · פנסיה-נט (רשות שוק ההון)</span>
...
<div class="wrap">
  ...
  <section>
    ...
    <p class="body"><b>במסלולים הכלליים אין הבדל של ממש.</b> הפער הכספי בין "רודף"
      ...
      מאפס. הפערים המובהקים היחידים הם במסלולי המניות ובפנסיה, שהם גם המסוכנים יותר,
      כך שהם עולים בקנה אחד עם פרמיית סיכון בתקופת שווקים עולים.</p>
  </section>
  ...
  <div class="foot" style="border-top:none;padding-top:0;margin-top:12px">
    ...
    הנתונים מבוססים על מקורות פומביים (גמל-נט ופנסיה-נט) וייתכנו בהם אי־דיוקים.
...
<main class="card">
  ...
  <p class="lede">בכל תחילת שנה זיהינו את הקופה שהשיגה את התשואה הגבוהה ביותר בקטגוריה
    שלה בשנה שחלפה, מבין מעל <span class="num">700</span> קופות הפתוחות לכלל הציבור, ועקבנו
    אחר הדירוג והתשואה שלה בשלוש השנים הבאות, בהפרדה בין קרן השתלמות, קופת גמל וקרן פנסיה.</p>
  ...
  <p class="disclaimer">גילוי נאות: התוכן נועד למידע כללי ולמטרות לימודיות בלבד, ואינו
    ...
    של כל אדם. הנתונים מבוססים על מקורות פומביים (גמל-נט ופנסיה-נט) וייתכנו בהם אי־דיוקים.
